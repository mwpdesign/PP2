...
async def create_provider(
    *,
    ...
    provider = await provider_service.create_provider(
        provider_in, created_by_id=current_user["id"]
    )
    return provider
...
async def update_provider(
    *,
    ...
    provider = await provider_service.update_provider(
        provider_id, provider_in, updated_by_id=current_user["id"]
    )
    return provider
...
async def search_providers(
    ...
    return ProviderSearchResults(total=total, providers=providers)
