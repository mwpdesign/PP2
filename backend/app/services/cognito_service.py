...
class CognitoService:
    ...
    async def confirm_password_reset(
        ...
        try:
            ...
            # Cognito returns an empty dict on successful password reset
            # We create our own response with status information
            ...
            error = e.response["Error"]
            raise CognitoError(
                f"Password reset confirmation failed: {error['Message']}"
            )
