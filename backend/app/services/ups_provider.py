...
class UPSProvider(ShippingProvider):
    ...
    async def create_label(
        ...
        try:
            ...
            audit_shipping_operation(
                ...
                carrier="UPS",
                details={"service_type": service_type, "reference": reference},
            )
    ...
    async def track_shipment(self, tracking_number: str) -> TrackingInfo:
        ...
        try:
            ...
            if response.status_code != 200:
                raise ShippingException(f"UPS API error: {response.text}")
    ...
    def _mock_tracking_response(self, tracking_number: str) -> TrackingInfo:
