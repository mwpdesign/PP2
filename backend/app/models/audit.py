...
class AuditLog(Base, AuditMixin):
    ...
    updated_by = relationship(
        "User", foreign_keys=[updated_by_id], back_populates="updated_audit_logs"
    )
...
class ComplianceCheck(Base, AuditMixin):
    ...
    # Relationships
    created_by = relationship(
        "User", foreign_keys=[created_by_id], back_populates="created_compliance_checks"
    )
    updated_by = relationship(
        "User", foreign_keys=[updated_by_id], back_populates="updated_compliance_checks"
    )
...
class AuditReport(Base, AuditMixin):
    ...
    # Relationships
    created_by = relationship(
        "User", foreign_keys=[created_by_id], back_populates="created_audit_reports"
    )
    updated_by = relationship(
        "User", foreign_keys=[updated_by_id], back_populates="updated_audit_reports"
    )
