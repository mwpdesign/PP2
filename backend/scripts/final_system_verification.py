...
class FinalSystemVerificationEngine:
    ...
    def verify_project_structure(self) -> Dict[str, Any]:
        ...
        required_dirs = {
            ...
            "backend": ["app/api", "app/core", "app/models", "app/services", "tests"],
            "infrastructure": ["modules/vpc", "modules/monitoring", "modules/backup"],
            "docs": ["runbooks", "api", "deployment"],
            "scripts": [],
        }
        ...
        results = {"directories": {}, "files": {}, "status": "PASS"}
        ...
        for base_dir, subdirs in required_dirs.items():
            ...
            for subdir in subdirs:
                ...
                subdir_status = {"exists": subdir_exists, "is_directory": subdir_is_dir}
    ...
    def verify_development_environment(self) -> Dict[str, Any]:
        ...
        results = {"tools": {}, "status": "PASS"}

        for tool, version_flag in required_tools:
            try:
                result = subprocess.run(
                    [tool, version_flag], capture_output=True, text=True
                )
    ...
    def verify_docker_services(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"docker_services": {"status": "FAIL", "error": str(e)}}
    ...
    def verify_database(self) -> Dict[str, Any]:
        ...
        results = {"connection": {}, "tables": {}, "status": "PASS"}
        ...
        try:
            ...
            results["connection"] = {"connected": True, "version": version}
            ...
            for table in required_tables:
                ...
                if exists:
                    ...
                    results["tables"][table] = {"exists": False, "status": "FAIL"}
                    results["status"] = "FAIL"

            conn.close()

        except Exception as e:
            results["connection"] = {"connected": False, "error": str(e)}
            results["status"] = "FAIL"
    ...
    def verify_aws_services(self) -> Dict[str, Any]:
        ...
        for service_name, verify_func in required_services.items():
            try:
                ...
                results["services"][service_name] = {"status": "FAIL", "error": str(e)}
                results["status"] = "FAIL"
    ...
    def verify_security_compliance(self) -> Dict[str, Any]:
        ...
        results = {"checks": checks, "status": "PASS" if all_passed else "FAIL"}
    ...
    def _verify_ssl_config(self) -> Dict[str, Any]:
        ...
        try:
            requests.get("https://localhost:443", verify=True, timeout=5)
            return {
                "status": "PASS",
    ...
    def _verify_auth_config(self) -> Dict[str, Any]:
        ...
        required_vars = ["COGNITO_USER_POOL_ID", "COGNITO_CLIENT_ID", "JWT_SECRET"]
    ...
    def _verify_encryption_config(self) -> Dict[str, Any]:
        ...
        required_vars = ["KMS_KEY_ID", "ENCRYPTION_KEY"]
    ...
    def run_verification(self) -> Tuple[bool, Dict[str, Any]]:
        ...
        for verify_func in verifications:
            try:
                ...
                components[verify_func.__name__] = {"status": "FAIL", "error": str(e)}
