...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('territory_id', sa.Integer(), sa.ForeignKey('territories.id')),
    ...
    op.create_table(
        ...
        sa.Column('reported_at', sa.DateTime(), nullable=False, default=datetime.utcnow),
    ...
    op.create_index('ix_phi_access_user', 'phi_access_logs', ['user_id'])
    op.create_index('ix_phi_access_patient', 'phi_access_logs', ['patient_id'])
    op.create_index('ix_phi_access_territory', 'phi_access_logs', ['territory_id'])
    op.create_index('ix_phi_access_created', 'phi_access_logs', ['created_at'])
    op.create_index('ix_phi_access_resource', 'phi_access_logs', ['resource_type', 'resource_id'])

    op.create_index('ix_audit_logs_user', 'audit_logs', ['user_id'])
    op.create_index('ix_audit_logs_territory', 'audit_logs', ['territory_id'])
    op.create_index('ix_audit_logs_created', 'audit_logs', ['created_at'])
    op.create_index('ix_audit_logs_action', 'audit_logs', ['action'])

    op.create_index('ix_compliance_checks_type', 'compliance_checks', ['check_type'])
    op.create_index('ix_compliance_checks_territory', 'compliance_checks', ['territory_id'])
    op.create_index('ix_compliance_checks_status', 'compliance_checks', ['status'])
    op.create_index('ix_compliance_checks_created', 'compliance_checks', ['created_at'])

    op.create_index('ix_security_incidents_type', 'security_incidents', ['incident_type'])
    op.create_index('ix_security_incidents_territory', 'security_incidents', ['territory_id'])
    ...
    op.create_index('ix_security_incidents_reported', 'security_incidents', ['reported_at'])

    op.create_index('ix_audit_reports_type', 'audit_reports', ['report_type'])
    op.create_index('ix_audit_reports_territory', 'audit_reports', ['territory_id'])
    op.create_index('ix_audit_reports_period', 'audit_reports', ['start_date', 'end_date'])
    op.create_index('ix_audit_reports_created', 'audit_reports', ['created_at'])
