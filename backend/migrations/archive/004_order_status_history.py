...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "changed_by", sa.Integer(), sa.ForeignKey("users.id"), nullable=False
        ),
        sa.Column(
            "territory_id",
            sa.Integer(),
    ...
    op.create_index(
        "ix_order_status_history_order", "order_status_history", ["order_id"]
    )
    op.create_index(
        "ix_order_status_history_territory", "order_status_history", ["territory_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_order_status_history_created", "order_status_history", ["created_at"]
    )
