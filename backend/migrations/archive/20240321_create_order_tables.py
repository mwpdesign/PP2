...
def upgrade() -> None:
    ...
    op.create_index(
        'ix_order_status_history_timestamp',
        'order_status_history',
        ['timestamp']
    )

    op.create_index(
        'ix_order_approvals_order_id',
        'order_approvals',
        ['order_id']
    )
    op.create_index(
        'ix_order_approvals_approver_id',
        'order_approvals',
        ['approver_id']
    )
    op.create_index(
        'ix_order_approvals_approval_type',
        'order_approvals',
        ['approval_type']
    )
    op.create_index(
        'ix_order_approvals_status',
        'order_approvals',
        ['status']
    )
    op.create_index(
        'ix_order_approvals_timestamp',
        'order_approvals',
        ['timestamp']
    )
