...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            'security_policy', JSONB, nullable=False, server_default='{}'
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            'parent_role_id', UUID(as_uuid=True), sa.ForeignKey('roles.id')
        ),
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint(
            'name', 'organization_id', name='uq_role_name_org'
        )
    )
    ...
    op.create_table(
        ...
        sa.Column(
            'parent_territory_id', UUID(as_uuid=True),
    ...
    op.create_table(
        ...
        sa.Column(
            'primary_territory_id', UUID(as_uuid=True),
            sa.ForeignKey('territories.id')
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            'territory_id', UUID(as_uuid=True),
            sa.ForeignKey('territories.id'), nullable=False
        ),
        sa.Column(
            'role_id', UUID(as_uuid=True),
            sa.ForeignKey('roles.id'), nullable=False
    ...
    op.create_table(
        ...
        sa.Column(
            'encryption_context', JSONB, nullable=False, server_default='{}'
        ),
        sa.Column(
            'created_at', sa.DateTime(), nullable=False,
            default=datetime.utcnow
    ...
    op.create_index(
        'ix_territories_parent', 'territories', ['parent_territory_id']
    )
