...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "reported_by", sa.Integer(), sa.ForeignKey("users.id"), nullable=False
        ),
        sa.Column(
            "territory_id",
            sa.Integer(),
        ...
        sa.Column(
            "reported_at", sa.DateTime(), nullable=False, default=datetime.utcnow
        ),
    ...
    op.create_index(
        "ix_phi_access_resource", "phi_access_logs", ["resource_type", "resource_id"]
    )
    ...
    op.create_index(
        "ix_compliance_checks_territory", "compliance_checks", ["territory_id"]
    )
    ...
    op.create_index(
        "ix_security_incidents_type", "security_incidents", ["incident_type"]
    )
    op.create_index(
        "ix_security_incidents_territory", "security_incidents", ["territory_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_security_incidents_reported", "security_incidents", ["reported_at"]
    )
    ...
    op.create_index(
        "ix_audit_reports_period", "audit_reports", ["start_date", "end_date"]
    )
