...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("shelf", "bin", "rack", "zone", "aisle", name="location_type"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum(
                "addition", "removal", "transfer", "adjustment", name="transaction_type"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "condition",
            sa.Enum("new", "used", "damaged", "expired", name="stock_condition"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("LOW", "MEDIUM", "HIGH", "URGENT", name="ivrpriority"),
            nullable=False,
        ),
        sa.Column(
            "status",
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("routine", "urgent", "emergency", name="order_priority_enum"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("low", "normal", "high", "urgent", name="fulfillment_priority"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "condition",
            sa.Enum("new", "used", "damaged", "expired", name="return_condition"),
            nullable=False,
        ),
        sa.Column(
            "status",
    ...
    op.create_table(
        ...
        sa.Column(
            "address_type",
            sa.Enum("from", "to", name="address_type_enum"),
            nullable=False,
        ),
