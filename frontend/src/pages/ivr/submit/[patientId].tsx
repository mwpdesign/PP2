...
import PatientInformationStep from '../../../components/ivr/PatientInformationStep';
import ProductAndTreatmentStep from '../../../components/ivr/ProductAndTreatmentStep';
...
import { createInitialTracking, updateTrackingTimestamp, updateIVRStatus } from '../../../utils/ivrUtils';
...
const IVRSubmissionPage: React.FC = () => {
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      ...
      const updatedTracking = updateTrackingTimestamp(formData.tracking);
      ...
      await new Promise(resolve => setTimeout(resolve, 1000));
      console.log('Saving draft:', updatedFormData);
    } catch (error) {
